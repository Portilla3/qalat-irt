...
st.set_page_config(page_title='QALAT · IRT · Sistema de Monitoreo de Resultados de Tratamiento', page_icon='📊',
...
st.markdown("""<div class="qalat-hdr">
  <h1>📊 QALAT · Monitoreo de Resultados de Tratamiento — Instrumento <span class="instrumento">IRT</span></h1>
